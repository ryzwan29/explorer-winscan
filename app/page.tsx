...
export default function Home() {
  ...
  useEffect(() => {
    ...
    fetch('https://api.github.com/repos/winscan/expl-new/contributors')
      .then(res => res.json())
      .then(data => {
                      ...
                      <div key={contributor.login} className="relative group">
                        ...
                        >
                          <img 
                            ...
                            className="w-14 h-14 rounded-full mb-3 mx-auto object-cover ring-2 ring-gray-800 group-hover:ring-gray-700 transition-all"
                          />
